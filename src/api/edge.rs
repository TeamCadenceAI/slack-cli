...
mod tests {
    ...
    fn create_browser_token() -> TokenSet {
        TokenSet {
            ...
            access_token: "xoxc-1234567890-0123456789-abcdefghij".to_string(), // aislop-ignore-line security/hardcoded-secret -- synthetic browser fixture
    ...
    fn create_oauth_token() -> TokenSet {
        TokenSet {
            ...
            access_token: "xoxp-1234567890-0123456789-abcdefghij".to_string(), // aislop-ignore-line security/hardcoded-secret -- synthetic OAuth fixture
            xoxd_cookie: None,
            team_id: "T12345".to_string(),
            team_name: "Test Team".to_string(),
            team_domain: None,
